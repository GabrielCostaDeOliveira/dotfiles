    ...
    local mappings = {
      {
        ...
        { "<leader>p",  group = "Plugin Manager (Lazy)",                                                                                     nowait = true,                  remap = false },
        { "<leader>pS", "<cmd>Lazy<cr>",                                                                                                     desc = "Status (UI)",           nowait = true, remap = false },
        { "<leader>pc", "<cmd>Lazy clean<cr>",                                                                                               desc = "Clean unused plugins",  nowait = true, remap = false },
        { "<leader>pd", "<cmd>Lazy debug<cr>",                                                                                               desc = "Debug info",            nowait = true, remap = false },
        { "<leader>pi", "<cmd>Lazy install<cr>",                                                                                             desc = "Install new plugins",   nowait = true, remap = false },
        { "<leader>pl", "<cmd>Lazy log<cr>",                                                                                                 desc = "View log",              nowait = true, remap = false },
        { "<leader>ps", "<cmd>Lazy sync<cr>",                                                                                                desc = "Sync (update + clean)", nowait = true, remap = false },
        { "<leader>pu", "<cmd>Lazy update<cr>",                                                                                              desc = "Update plugins",        nowait = true, remap = false },
